...
---------REPORTE DINERO FRESCO-----------------------------------------------------------------------------
	...
	WHERE
		...
		CAST(a.fechausuario AS DATE) BETWEEN @FECHA7 AND @FECHA
		AND (
		...
		INTO #MOVIMIENTOS
		FROM #REPORTEDINEROFRESCO WHERE FECHAMOVIMIENTO>=@FECHA7
...
-------DINERO FRESO DEL MISMO DIA CON EL MISMO TIPO DE MONEDA
		...
		SELECT * FROM #REPORTEDINEROFRESCO WHERE CodSocio='0003451'

		SELECT * FROM #MOVIMIENTOS2 WHERE   CodSocio='0003451'

		SELECT * FROM #APERTURAS WHERE CODIGOSOCIO='0003451'

		SELECT * FROM #APERTURAS_DETALLE  WHERE CODIGOSOCIO='0003451'

		SELECT MONTOINICIAL,* FROM WT_REPORTEPASIVAS  WHERE CODIGOSOCIO='0003451'
		AND ESTADO ='Activa' AND (TIPOPRODUCTO = 'Plazo Fijo' ) AND NROCUENTA='000345113003'
		ORDER BY FECHA ASC

		SELECT MONTOINICIAL * FROM DW_DATOSCUENTACORRIENTE  WHERE NUMEROCUENTA='000345113003'